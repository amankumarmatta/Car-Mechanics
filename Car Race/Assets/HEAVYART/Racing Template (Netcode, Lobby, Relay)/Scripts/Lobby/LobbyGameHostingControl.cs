...
namespace HEAVYART.Racing.Netcode
{
    public class LobbyGameHostingControl
    {
        ...
        private int waitBeforeLoadSceneDelay;
        ...
        public LobbyGameHostingControl(LobbyDataControl dataControl, UnityTransport unityTransport)
        {
            ...
            waitBeforeLoadSceneDelay = SettingsManager.Instance.lobby.waitBeforeLoadSceneDelay;
            UpdateRegions();
        }
        ...
        public async void JoinHostedGame()
        {
            ...
            //Synchronize with other players before loading game scene
            //Make sure everyone has spawned service user object
            await Task.Delay(waitBeforeLoadSceneDelay);
        ...
        private async void UpdateRegions()
        {
            ...
            {
                Debug.Log("Add region: " + result.Region + " " + result.AverageLatencyMs);
