...
namespace HEAVYART.Racing.Netcode
{
    public static class PlayerDataKeeper
    {
        ...
        public static int selectedCarModel
        {
            get => PlayerPrefs.GetInt(authProfileName + "selectedCarModel", 0);
            set => PlayerPrefs.SetInt(authProfileName + "selectedCarModel", value);
        }
