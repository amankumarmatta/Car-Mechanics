...
public partial class @RCC_InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@RCC_InputActions()
    {
        Debug.Assert(!m_Vehicle.enabled, "This will cause a leak and performance issues, RCC_InputActions.Vehicle.Disable() has not been called.");
        Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, RCC_InputActions.Camera.Disable() has not been called.");
        Debug.Assert(!m_Optional.enabled, "This will cause a leak and performance issues, RCC_InputActions.Optional.Disable() has not been called.");
    }
